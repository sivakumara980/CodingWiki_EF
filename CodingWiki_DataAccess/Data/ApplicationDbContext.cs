...
namespace CodingWiki_DataAccess.Data
{
    ...
    new BookDetail { BookDetail_Id = 8, NumberOfChapters = 25, NumberOfPages = 250, Weight = "2.5kg" }
            ...
            modelBuilder.Entity<Book>().HasData(
                new Book { BookId = 1, Title = "MyStroy", ISBN = "12525", Price = 10.25m, BookDetail_Id = 1 },
                new Book { BookId = 2, Title = "NASA", ISBN = "85485", Price = 559.27m, BookDetail_Id = 2 },
                new Book { BookId = 3, Title = "MakeMyTrip", ISBN = "1995", Price = 6.14m, BookDetail_Id = 3 },
                new Book { BookId = 4, Title = "Google", ISBN = "2022", Price = 85.56m, BookDetail_Id = 4 },
                new Book { BookId = 5, Title = "MSTeams", ISBN = "20254", Price = 17.2m, BookDetail_Id = 5 },
                new Book { BookId = 6, Title = "FitApp", ISBN = "2055", Price = 5874.27m, BookDetail_Id = 6 },
                new Book { BookId = 7, Title = "Paytm", ISBN = "7845", Price = 121.25m, BookDetail_Id = 7 },
                new Book { BookId = 8, Title = "Gpay", ISBN = "7452", Price = 879.27m, BookDetail_Id = 8 }
            );
